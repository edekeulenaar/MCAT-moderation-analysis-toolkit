...
entities as well as their leaders, founders, or prominent members. 
...
1 Note from Facebook’s records: “This update does not make substantive changes to 

the Dangerous Organizations and Individuals policy, but rather restructures the 

formatting, consolidates and formalizes adjustments announced in various 

statements but not listed in the Community Standards, and updates the policy 

rationale to better reflect our thinking surrounding dangerous organizations and 

individuals in order to offer additional user transparency.” 
...
We do not allow individuals or organizations involved in terrorism, organized hate, or 

organized crime to have a presence on our platforms. We also don&apost allow other 

people to represent these entities on our services. We do not allow leaders or 
...
**7. Child Sexual Exploitation, Abuse and Nudity****2**
...
2 Note from Facebook’s records: “These edits do not reflect policy changes, rather 
...
**9. Bullying and Harassment****3** 

**II. Safety** 

 

3 Note from Facebook’s records: “In response to an Oversight 

Board recommendation we committed to reformat the Bullying and Harassment 

Community Standard to clearly define the approach to different target user 

categories. Edits to this section have been made to reformat the section accordingly 

and bring alignment with internal documentation for transparency. We’re also 

updating our policy on mass harassment which was based on global engagement 

with a broad range of stakeholders directly impacted by the policy, including feminist 

and women&aposs rights activists, representatives of the LGBT community, minority 

groups, journalists, human rights activists, and public figures. We also connected 

with experts who study online harassment and state-sponsored influence operations, 

as well as advocates for freedom of expression. In our consultations, we explored 

the way stakeholders experienced brigading and mass harassment on our platforms, 

including the actors and targets involved, the tactics employed, and the coordinated 

nature of such attacks. We also discussed at length the numerous online and offline 

harms that may stem from such behaviors as well as the challenges in differentiating 

between legitimate forms of mass activity and abusive forms of brigading. Overall, 

stakeholders acknowledged that mass activity used for activism versus for harmful 

brigading can often exhibit similar online behaviors (i.e. mass reporting, comment 

flooding, or hashtag bombing). It was therefore recommended that we focus on 

context-specific factors to differentiate between legitimate and illegitimate use-cases, 

such as the nature of the content posted, the impact on the victim, and the 

behavior&aposs potential for offline harm. The input received on such issues was used to 

craft the first iteration of our brigading and mass harassment policy.” 
...
4 Note from Facebook’s records: “This update was based on stakeholder 

engagement with a broad range of academics and civil society organizations 

affected by the policy, including experts in dangerous speech and atrocity 

prevention, human rights practitioners, social psychologists who study issues of 

personal identity, advocates for freedom of expression, and groups representing 

religious and non-religious world views. In our consultations, we explored the harms 

that may stem from attacks on concepts, ideas, and institutions; we also listened to 

stakeholders describe the legitimate role of such speech in advancing public 

discourse and preserving dissent. Speech that was perceived as hurtful by some 

stakeholder groups was regarded as serving a valuable civic purpose by others. Two 
...
themes stood out: The first was the importance of ensuring that attacks on concepts, 

ideas, and institutions do not contribute to real world harm. This concern found 

expression in support for international guidelines on incitement to hatred (e.g., the 

Rabat Plan of Action). The second was the importance of factors such as history, 

local power dynamics, the status of the speaker, and ongoing civic tension -- which 

may tip the scales in favor of removing attacks in some circumstances but not 

others. We used the input we received on these points to craft a revision to our hate 
