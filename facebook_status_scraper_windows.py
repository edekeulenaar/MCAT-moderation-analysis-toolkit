...
def process_file(src_path, dest_path):
    ...
    driver_path = 'C:\\path\\to\\chromedriver.exe'  # Specify the path to your ChromeDriver
...
def main():
    ...
    path = '/Users/edekeulenaar/Projects/PhDs/PhD 2020-2025/Datasets 🧮 /Infodemic/us election 2020/Facebook'  # Update this to your specific file or folder path
